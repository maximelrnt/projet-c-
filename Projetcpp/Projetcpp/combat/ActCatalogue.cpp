// ActCatalogue.cpp — Initialisation du catalogue statique des actions ACT
...
void ActCatalogue::init() {
    ...
    // Eric Cartman (BOSS)
    s_actions.insert({"RAGER",       ActAction("RAGER",       "Tu piques crise de rage. Cartman se reconnait en toi.",   +15)});
    s_actions.insert({"PLEURNICHER", ActAction("PLEURNICHER", "Tu pleurniches. Cartman est machiavelement attendri.", +20)});
